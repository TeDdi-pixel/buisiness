    ...
    <main>
      <div class="container">
        <ul class="breadcrumb">
          ...
          <li>
            <span>&nbsp;/</span>
            <strong href="">Каталог товарів</strong>
          </li>
        </ul>
        <div class="catalog">
          <div class="catalog__left">
            <div class="catalog__top catalog__border-bottom">
              <h2 class="catalog__title">Фільтр</h2>
              <button class="catalog__cancled">Скасувати</button>
            </div>
            <div class="catalog__budget catalog__border-bottom">
              <h4 class="catalog__sub-title">ЯКИЙ ВАШ БЮДЖЕТ?</h4>
            ...
            <div class="catalog__spoiler catalog__border-bottom" id="characteristic_name">
              <div class="catalog__cont">
                ...
                <div class="catalog__desc" id="cat">
                  <!--
                  <a href="">
                    <input type="checkbox" name="kompyutery_do_15_000_grn">
          ...
          <div class="catalog__right">
            <h2 class="catalog__title" id="catalogTitle">Ігрові девайси</h2>
            <p class="catalog__text">
              Ігровий сучасний продуктивний комп'ютер який поєднує в собі
              оптимально підібрані комплектуючі для ігор і розваг. Можлива
              індивідуальна збірка ігрового ПК під замовлення. Зв'яжіться з
              нами, і ми будемо раді допомогти вибрати Ваш ідеальний ігровий
              комп'ютер!
            </p>
            <div class="catalog__sort">
              <span>Сортувати:</span>
              <button class="catalog__sort_active ascending">Від дешевих</button>
              <button class="catalog__sort_active descending">Від дорогих</button>
            </div>
            <div class="catalog__content" id="prod">
              <!--<div class="catalog__item" id="img1">
                <img src="img/home-cat__img.jpg" alt="" class="catalog__img" />
                <h4 class="catalog__name">
                  <a href="">Оптимальный Игровой R5 3600 GTX 1630 16Gb</a>
                </h4>
                ...
                <div class="catalog__price-block">
                  <div class="catalog__price">
                    <span class="catalog__price-old">25419 грн</span>
                    <span class="catalog__price-new">22903 грн</span>
                  </div>
                  <div class="catalog__save">
                    <span class="catalog__percent">
                      Економія <span class="catalog__save-price">10</span> %
                    </span>
                    <div class="catalog__save-price">2516 грн</div>
                  </div>
                </div>
