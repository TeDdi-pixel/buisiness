            ...
            <div class="header__wrapper">
                <nav class="header__menu">
                    <ul>
                        ...
                        <li><a href="changeProd.php" class="header__link">Редагувати товари</a></li>
        ...
        <h2 class="title title_margin">Адмін-панель</h2>
            <div class="admin-panel">
                <div class="panel__wrapper">
                    <h1 class="admin-panel__title">Створити значення характеристики</h1>
                    <form id="addValueForm" action="back/addValueAdmin.php" method="POST" class="admin-panel__form">
                        <div class="admin-panel__wrapper">
                            <label for="value" class="admin-panel__label">Назва:</label>
                            <input type="text" id="value" name="value" required class="admin-panel__input">
                        </div>
                        <div class="admin-panel__wrapper">
                            <label for="product_id" class="admin-panel__label">Ім'я категорії:</label>
                            <select id="product_id" name="product_id" class="admin-panel__input">
                        ...
                        <div class="admin-panel__wrapper">
                            <label for="characteristic_id" class="admin-panel__label">Ім'я категорії:</label>
                            <select id="characteristic_id" name="characteristic_id" class="admin-panel__input">
                                <option value="" selected disabled>Оберіть назву</option>
                                <?php
                                require_once 'back/env.php';
                                $mysqli = new mysqli("localhost", $GLOBALS['db_user'], $GLOBALS['db_pass'], $GLOBALS['db_name']);
                                $result = $mysqli->query("SELECT * FROM characteristics");
                                while ($row = $result->fetch_assoc()) {
                                    echo "<option value='" . $row['id'] . "'>" . $row['name'] . "</option>";
                                }
                                ?>
                        ...
                        <button class="admin-panel__button" type="submit" name="add_value" id="sendBTN">Створити</button>
                    </form>
                    <div class="admin-panel__wrapper">
                ...
                <div class="panel__wrapper">
                    <h1 class="admin-panel__title">Змінити Характеристику</h1>
                    <form class="admin-panel__form" id="updateValueForm" action="back/updateValueAdmin.php" method="POST">
                        <div class="admin-panel__wrapper">
                            <label for="id" class="admin-panel__label">Старе значення характеристики:</label>
                            <select id="id" name="id" required class="admin-panel__input">

                                <?php
                                require_once 'back/env.php';
                                $mysqli = new mysqli("localhost", $GLOBALS['db_user'], $GLOBALS['db_pass'], $GLOBALS['db_name']);
                                $result = $mysqli->query("SELECT * FROM values_of_characteristics");
                                echo "<option value='' selected disabled>Оберіть значення</option>";
                                while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="admin-panel__wrapper">
                            <label for="value" class="admin-panel__label">Нове значення:</label>
                            <input type="text" id="value" name="value" class="admin-panel__input">
                        <button type="submit" name="update_value" id="sendBTN" class="admin-panel__button">Змінити</button>
                ...
                <div class="panel__wrapper">
                    <h1 class="admin-panel__title">Видалити Хатактеристику</h1>
                    <form id="deleteValueForm" action="back/deleteValueAdmin.php" method="POST" class="admin-panel__form">
                        <label for="id" class="admin-panel__label">Назва продукту:</label>
                        ...
                        <button type="submit" name="delete_value" id="sendBTN" class="admin-panel__button">Видалити</button>
                        <br>
                    </form>
                    <div class="admin-panel__wrapper">
