    ...
    <main>
        ...
        <h2 class="title title_margin">Адмін-панель</h2>
            <div class="admin-panel">
                <!--<a href="index.html" class="admin-panel__navigation">Повернутися</a>-->
                <div class="panel__wrapper">
                    <h1 class="admin-panel__title">Створити Категорію</h1>
                    <form id="addCategoryForm" action="back\insertCategoryAdmin.php" method="POST" class="admin-panel__form">
                        <div class="admin-panel__wrapper">
                            <label for="name" class="admin-panel__label">Ім'я категорії:</label>
                            <input type="text" id="name" name="name" class="admin-panel__input " required>
                        </div>

                        <div class="admin-panel__wrapper">
                            <label for="image_link" class="admin-panel__label">Шлях до картинки:</label>
                            <input type="text" id="image_link" name="image_link" class="admin-panel__input" required>
                        </div>
                        <div class="admin-panel__wrapper">
                            <button type="submit" name="add_category" id="sendBTN" class="admin-panel__button">Створити</button>
                        </div>
                ...
                <div class="panel__wrapper">
                    <h1 class="admin-panel__title">Змінити Категорію</h1>
                    <form class="admin-panel__form" id="updateCategoryForm" action="back/updateCategoryAdmin.php" method="POST">
                        <div class="admin-panel__wrapper">
                            <label for="category_id" class="admin-panel__label">Ім'я категорії:</label>
                            <select id="category_id" name="category_id" required class="admin-panel__input">

                                <?php
                                require_once 'back/env.php';
                                $mysqli = new mysqli("localhost", $GLOBALS['db_user'], $GLOBALS['db_pass'], $GLOBALS['db_name']);
                                $result = $mysqli->query("SELECT * FROM categories");
                                echo "<option value='' selected disabled>Оберіть категорію</option>";
                        ...
                        <div class="admin-panel__wrapper">
                            ...
                            <button type="submit" name="update_category" class="admin-panel__button" id="sendBTN">Змінити</button>
                        </div>
                ...
                <div class="panel__wrapper">
                    <h1 class="admin-panel__title">Видалити Категорію</h1>
                    <form id="deleteCategoryForm" action="back/deleteCategoryAdmin.php" method="POST" class="admin-panel__form">
                        <div class="admin-panel__wrapper">
                            <label for="id" class="admin-panel__label">Ім'я категорії:</label>
                            ...
                            <button type="submit" name="delete_category" id="sendBTN" class="admin-panel__button">Видалити</button>
