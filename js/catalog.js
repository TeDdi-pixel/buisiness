$(function () {
  ...
  document.querySelector(".ascending").addEventListener("click", sort);
  document.querySelector(".descending").addEventListener("click", sort);
  ...
  for (const key in js) {
    ...
    <div class="catalog__price-block">
      <div class="catalog__price">
        <span class="catalog__price-new">${js[key].price} ₴</span>
      </div>
...
let cancelAll = document.querySelector('.catalog__cancled');
