    ...
    <main>
            ...
            <div class="admin-panel">
                <div class="panel__wrapper">
                    <h1 class="admin-panel__title">Створити Характеристику</h1>
                    <form id="addCharForm" action="back/addCharAdmin.php" method="POST" class="admin-panel__form">
                        <div class="admin-panel__wrapper">
                            <label for="name" class="admin-panel__label">Назва:</label>
                            <input type="text" id="name" name="name" required class="admin-panel__input">
                        </div>
                        <div class="admin-panel__wrapper">
                            <label for="category_id" class="admin-panel__label">Ім'я категорії:</label>
                            <select id="category_id" name="category_id" class="admin-panel__input">
                        ...
                        <button class="admin-panel__button" type="submit" name="add_char" id="sendBTN">Створити</button>
                    </form>
                    <div class="admin-panel__wrapper">
                ...
                <div class="panel__wrapper">
                    ...
                    <form class="admin-panel__form" id="updateCharForm" action="back/updateCharAdmin.php" method="POST">
                        <div class="admin-panel__wrapper">
                            <label for="characteristic_id" class="admin-panel__label">Ім'я категорії:</label>
                            <select id="characteristic_id" name="characteristic_id" required class="admin-panel__input">
                        ...
                        <button type="submit" name="update_char" id="sendBTN" class="admin-panel__button">Змінити</button>
                ...
                <div class="panel__wrapper">
                    ...
                    <form id="deleteCharForm" action="back/deleteCharAdmin.php" method="POST" class="admin-panel__form">
                    ...
                    <div class="admin-panel__wrapper last">
